...
export const buttonVariants = cva("inline-block border px-12 ", {
  variants: {
    variant: {
      default:
        "flex gap-2 items-center flex-nowrap rounded-lg border hover:backdrop-blur-sm border-transparent px-3 py-1 transition-colors hover:border-gray-300 hover:bg-gray-100/30 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30",
